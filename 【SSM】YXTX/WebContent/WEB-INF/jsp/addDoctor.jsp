...
<body>
	<div class="addDoctor">
		<form class="layui-form" action="DoctorInfoAdd.do">
			
		  <div class="layui-form-item" style="width: 600px;">
		    <label class="layui-form-label">医生姓名</label>
		    <div class="layui-input-block">
		      <input type="text" name="doctorName" required  lay-verify="required" placeholder="请输入姓名" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  ...
		  <div class="layui-form-item" style="width: 600px;">
		    ...
		    <div class="layui-input-block">
		      <input type="date" name="doctorBirthday" required  lay-verify="required" placeholder="2XXX-XX-XX" autocomplete="off" class="layui-input">
		    </div>
		  </div>
		  ...
		  <div class="layui-form-item" style="width: 600px;">
		    ...
		    <div class="layui-input-block">
		      <input type="date" name="jobTiem" required  lay-verify="required" placeholder="2XXX-XX-XX" autocomplete="off" class="layui-input">
		    </div>
		  </div>
