	...
	<body>
		<div class="layui-layout layui-layout-admin">
			<div class="layui-header header">
				...
				<div class="layui-logo header_title"><a href="main.html">
...
<!-- 						<li class="layui-nav-item layui-this">
						...
						<li class="layui-nav-item layui-nav-itemed">
							...
							<dl class="layui-nav-child">
								...
								<dd class="">
									<a href="javascript:;" data-title="医生信息查询" data-type="tabAdd" class="site-demo-active" data-id="docListServlet" data-url="docListServlet">
										<cite>医生信息查询</cite>
									</a>
								</dd>
								...
								<dd class="">
									<a href="javascript:;" data-title="医生信息添加" data-type="tabAdd" class="site-demo-active" data-id="addDocServlet" data-url="addDoctor.jsp">
										<cite>医生信息添加</cite>
									</a>
								</dd>
								<dd class="">
						...
						<li class="layui-nav-item layui-nav-itemed">
							...
							<dl class="layui-nav-child">
								...
								<dd class="">
									<a href="javascript:;" data-title="病床信息查询" data-type="tabAdd" class="site-demo-active" data-id="BedServlet" data-url="BedServlet">
										<cite>病床信息查询</cite>
									</a>
								</dd>
						...
						<li class="layui-nav-item layui-nav-itemed">
							...
							<dl class="layui-nav-child">
								...
								<dd class="">
									<a href="javascript:;" data-title="病人信息查询" data-type="tabAdd" class="site-demo-active" data-id="PatientServlet" data-url="PatientServlet">
										<cite>病人信息查询</cite>
									</a>
								</dd>
						...
						<li class="layui-nav-item layui-nav-itemed">
							...
							<dl class="layui-nav-child">
								...
								<dd class="">
									<a href="javascript:;" data-title="医生会诊统计" data-type="tabAdd" class="site-demo-active" data-id="DocIcon" data-url="DocIcon.jsp">
										<cite>医生会诊统计</cite>
									</a>
								</dd>
								...
								<dd class="">
									<a href="javascript:;" data-title="诊所盈利统计" data-type="tabAdd" class="site-demo-active" data-id="ProfitIcon" data-url="ProfitIcon.jsp">
										<cite>诊所盈利统计</cite>
									</a>
								</dd>
				...
				<div class="layui-tab" style="width: 100%;height: 100%" lay-filter="demo" lay-allowClose="true" >
					...
					<div class="layui-tab-content" style="width: 100%;height: 100%">
					    <div class="layui-tab-item layui-show">
					        <iframe src="hello.jsp" scrolling="no" frameborder="0"  style=" width: 100%;height: 100%" ></iframe>
					    </div>
					</div>
		...
		<script language="JavaScript">
		    window.alert("谢谢您的访问！年久失修，不在修复bug")
		    if (window != top) {
